 ...
 */
final class Version20260404161248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre ADD CONSTRAINT FK_AF86866FC4FFA84E FOREIGN KEY (expert_comptable_id) REFERENCES expert_comptable (id)');
    }
