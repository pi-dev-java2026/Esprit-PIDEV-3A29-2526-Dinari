...
<div class=\"hero-btns\">
<a href=\"#\" class=\"btn-primary\" onclick=\"openAuth('register');return false;\">Commencer gratuitement</a>
<a href=\"#fonctionnalites\" class=\"btn-secondary\">Découvrir</a>
</div>
</div>
</section>
...
<div class=\"cours-card reveal\"><div class=\"cours-level\">Débutant</div><h4>Les bases du budget</h4><p>Créez et gérez un budget personnel efficace dès le premier mois.</p><a href=\"#\" class=\"cours-link\">Voir le cours →</a></div>
<div class=\"cours-card reveal\"><div class=\"cours-level\">Intermédiaire</div><h4>Épargne & investissement</h4><p>Stratégies pour épargner intelligemment et faire fructifier votre argent.</p><a href=\"#\" class=\"cours-link\">Voir le cours →</a></div>
<div class=\"cours-card reveal\"><div class=\"cours-level\">Avancé</div><h4>Comprendre la banque</h4><p>Taux d'intérêt, crédits, cartes bancaires — tout ce que vous devez savoir.</p><a href=\"#\" class=\"cours-link\">Voir le cours →</a></div>
</div>
<div style=\"text-align:center;margin-top:40px;\" class=\"reveal\">
<a href=\"";
        // line 363
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cours_index");
        yield "\" class=\"btn-primary\">Accéder à tous les cours</a>
</div>
</div>
</section>
...
<div style=\"text-align:center;margin-top:40px;\" class=\"reveal\">
<a href=\"{{ path('app_cours_index') }}\" class=\"btn-primary\">Accéder à tous les cours</a>
</div>
</div>
</section>
