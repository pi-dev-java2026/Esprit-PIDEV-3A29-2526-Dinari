...
class Cours extends \App\Entity\Cours implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'chapitres' => [parent::class, 'chapitres', null, 16],
        ...
        "\0".parent::class."\0".'nomCours' => [parent::class, 'nomCours', null, 16],
        "\0".parent::class."\0".'quizzes' => [parent::class, 'quizzes', null, 16],
        'chapitres' => [parent::class, 'chapitres', null, 16],
        ...
        'nomCours' => [parent::class, 'nomCours', null, 16],
