...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\AdminChapitreController' => 'getAdminChapitreControllerService',
            'App\\Controller\\Admin\\AdminCommentaireController' => 'getAdminCommentaireControllerService',
            'App\\Controller\\Admin\\AdminCoursController' => 'getAdminCoursControllerService',
            'App\\Controller\\Admin\\AdminDashboardController' => 'getAdminDashboardControllerService',
            'App\\Controller\\Admin\\AdminQuizController' => 'getAdminQuizControllerService',
            'App\\Controller\\Admin\\AdminStatistiquesController' => 'getAdminStatistiquesControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController' => 'getChapitreCrudControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController' => 'getCommentaireCrudControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController' => 'getCoursCrudControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\DinariDashboardController' => 'getDinariDashboardControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController' => 'getNotificationCrudControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController' => 'getQuizCrudControllerService',
            'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController' => 'getQuizResultatCrudControllerService',
            'App\\Controller\\Client\\ChatbotController' => 'getChatbotControllerService',
            'App\\Controller\\Client\\CoursController' => 'getCoursControllerService',
            'App\\Controller\\Client\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\Client\\NotificationController' => 'getNotificationControllerService',
            'App\\Controller\\Client\\QuizController' => 'getQuizControllerService',
            'App\\Controller\\Client\\RecommendationController' => 'getRecommendationControllerService',
            'App\\Controller\\Client\\StatistiquesController' => 'getStatistiquesControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ZTow4JOVI5', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.easyadmin'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('a5RD59RvPx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WcxSUUvOFu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('05BNRbVZLT', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZQ2bacU9Qv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('quiz.completed', [#[\Closure(name: 'App\\EventSubscriber\\NotificationEventSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\NotificationEventSubscriber'] ?? $container->load('getNotificationEventSubscriberService')), 'onQuizCompleted'], 0);
        $instance->addListener('recommendations.generated', [#[\Closure(name: 'App\\EventSubscriber\\NotificationEventSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\NotificationEventSubscriber'] ?? $container->load('getNotificationEventSubscriberService')), 'onRecommendationsGenerated'], 0);
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $e = ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\AdminControllerRegistry'] ?? self::getAdminControllerRegistryService($container));

        $instance = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\AdminRouterSubscriber(new \EasyCorp\Bundle\EasyAdminBundle\Factory\AdminContextFactory($container->targetDir.'', ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Factory\MenuFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Security\\AuthorizationChecker'] ?? self::getAuthorizationCheckerService($container)), ($container->privates['security.logout_url_generator'] ?? self::getSecurity_LogoutUrlGeneratorService($container)), (isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Menu\MenuItemMatcher((isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), $a), $d), $e, $b, $a, ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\ActionFactory'] ?? self::getActionFactoryService($container)), $d, new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry(['App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController' => 'App\\Entity\\Chapitre', 'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController' => 'App\\Entity\\Commentaire', 'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController' => 'App\\Entity\\Cours', 'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController' => 'App\\Entity\\Notification', 'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController' => 'App\\Entity\\Quiz', 'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController' => 'App\\Entity\\QuizResultat'], ['App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController' => 'd8d852f', 'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController' => '944c7c8', 'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController' => 'b30e0d3', 'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController' => '2b7cb0d', 'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController' => 'b39ec53', 'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController' => 'df0ff17'], ['App\\Entity\\Chapitre' => 'App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController', 'App\\Entity\\Commentaire' => 'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController', 'App\\Entity\\Cours' => 'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController', 'App\\Entity\\Notification' => 'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController', 'App\\Entity\\Quiz' => 'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController', 'App\\Entity\\QuizResultat' => 'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController'], ['d8d852f' => 'App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController', '944c7c8' => 'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController', 'b30e0d3' => 'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController', '2b7cb0d' => 'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController', 'b39ec53' => 'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController', 'df0ff17' => 'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController'])), ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\ControllerFactory'] ?? self::getControllerFactoryService($container)), ($container->privates['debug.controller_resolver'] ?? self::getDebug_ControllerResolverService($container)), $c, $c, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), $a, $container->targetDir.'', $e);
    ...
    {
        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\AdminControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\AdminControllerRegistry($container->targetDir.'', ['App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController' => 'App\\Entity\\Chapitre', 'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController' => 'App\\Entity\\Commentaire', 'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController' => 'App\\Entity\\Cours', 'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController' => 'App\\Entity\\Notification', 'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController' => 'App\\Entity\\Quiz', 'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController' => 'App\\Entity\\QuizResultat'], ['App\\Controller\\Admin\\EasyAdmin\\DinariDashboardController']);
    }
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        $instance = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\DinariDashboardController'] ?? $container->load('getDinariDashboardControllerService'));
        }, 1), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController'] ?? $container->load('getChapitreCrudControllerService'));
            yield 1 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController'] ?? $container->load('getCommentaireCrudControllerService'));
            yield 2 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\CoursCrudController'] ?? $container->load('getCoursCrudControllerService'));
            yield 3 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController'] ?? $container->load('getNotificationCrudControllerService'));
            yield 4 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\QuizCrudController'] ?? $container->load('getQuizCrudControllerService'));
            yield 5 => ($container->services['App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController'] ?? $container->load('getQuizResultatCrudControllerService'));
        }, 6), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4HKKwx5c1g', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cvaay3qaEE', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xh2-jrOYXz', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6I8SPWqGeQ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bs+HTZiAfV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5D3ZC09xjw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\AdminChapitreController', 'App\\Controller\\Admin\\AdminCommentaireController', 'App\\Controller\\Admin\\AdminCoursController', 'App\\Controller\\Admin\\AdminDashboardController', 'App\\Controller\\Admin\\AdminQuizController', 'App\\Controller\\Admin\\AdminStatistiquesController', 'App\\Controller\\Admin\\EasyAdmin\\ChapitreCrudController', 'App\\Controller\\Admin\\EasyAdmin\\CommentaireCrudController', 'App\\Controller\\Admin\\EasyAdmin\\CoursCrudController', 'App\\Controller\\Admin\\EasyAdmin\\DinariDashboardController', 'App\\Controller\\Admin\\EasyAdmin\\NotificationCrudController', 'App\\Controller\\Admin\\EasyAdmin\\QuizCrudController', 'App\\Controller\\Admin\\EasyAdmin\\QuizResultatCrudController', 'App\\Controller\\Client\\ChatbotController', 'App\\Controller\\Client\\CoursController', 'App\\Controller\\Client\\HomeController', 'App\\Controller\\Client\\NotificationController', 'App\\Controller\\Client\\QuizController', 'App\\Controller\\Client\\RecommendationController', 'App\\Controller\\Client\\StatistiquesController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\QuizResultatRepository' => ['privates', 'App\\Repository\\QuizResultatRepository', 'getQuizResultatRepositoryService', true],
        ], [
            ...
            'App\\Repository\\QuizResultatRepository' => '?',
        ])));
